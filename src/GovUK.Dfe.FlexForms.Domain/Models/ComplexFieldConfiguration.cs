namespace GovUK.Dfe.FlexForms.Domain.Models
{
    public class ComplexFieldConfiguration
    {
        ...
        /// <summary>
        /// Expression for the “Is this the right …?” confirmation inset. Empty keeps the built-in field list.
        /// Supports Markdown.
        /// </summary>
        public string ConfirmationDisplay { get; set; } = string.Empty;
        /// <summary>
        /// Expression for task / collection summary values. Empty keeps the built-in layout.
        /// Independent of <see cref="ConfirmationDisplay"/>. Supports Markdown.
        /// </summary>
